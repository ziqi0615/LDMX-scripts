...
def main():
    ...
    for proc in procs:
        ...
        # Branches needed
        proc.ecalVeto     = proc.addBranch('EcalVetoResult', 'EcalVeto_test')
        proc.targetSPHits = proc.addBranch('SimTrackerHit', 'TargetScoringPlaneHits_test')
        proc.ecalSPHits   = proc.addBranch('SimTrackerHit', 'EcalScoringPlaneHits_test')
        proc.ecalRecHits  = proc.addBranch('EcalHit', 'EcalRecHits_test')
